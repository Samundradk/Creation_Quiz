  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: ResponsiveContainer(
        isDark: true,
        child: SafeArea(
          // Notch/Status bar bata bachhauna
          child: Padding(
                ...
                Row(
                  children: const [
                    Expanded(
                        child: SoulCard(
                            title: "MEDITATIVE",
                            imagePath: "assets/meditative_soul.png")),
                    SizedBox(width: 8),
                    Expanded(
                        child: SoulCard(
                            title: "PAMPERED",
                            imagePath: "assets/pampered_soul.png")),
                    SizedBox(width: 8),
                    Expanded(
                        child: SoulCard(
                            title: "IMMERSIVE",
                            imagePath: "assets/immersive_soul.png")),
                  ],
                ),
