      ...
      body: FutureBuilder<List<Question>>(
        ...
        builder: (context, snapshot) {
          ...
          if (questions.isEmpty) {
            return const Center(child: Text("No questions found in Firestore!"));
          }
          ...
          return ResponsiveContainer(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  // --- 1. FIXED TOP SECTION (Counter & Question) ---
                  ...
                  // --- 3. FIXED BOTTOM SECTION (Next Button) ---
                  const SizedBox(height: 20),
                  SizedBox(
                    width: double.infinity,
